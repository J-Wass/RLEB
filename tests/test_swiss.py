...
class TestSwissLookup(RLEBAsyncTestCase):
    ...
    async def test_swiss_complete(self):
        ...
        with patch.object(rleb_stdout, 'print_to_channel') as mocked_print_to_channel:
            await rleb_swiss.handle_swiss_lookup('https://liquipedia.net/rocketleague/Rocket_League_Championship_Series/2021-22/Fall/North_America/2', mock_channel)
    ...
    async def test_swiss_incomplete(self):
        ...
        with patch.object(rleb_stdout, 'print_to_channel') as mocked_print_to_channel:
            await rleb_swiss.handle_swiss_lookup('https://liquipedia.net/rocketleague/Rocket_League_Championship_Series/2021-22/Spring/North_America/1/Closed_Qualifier',
                                                      mock_channel)
    ...
    async def test_swiss_parenthesis(self):
        ...
        with patch.object(rleb_stdout,
            ...
            await rleb_swiss.handle_swiss_lookup('https://liquipedia.net/rocketleague/Rocket_League_Championship_Series/2021-22/Fall/Sub-Saharan_Africa/1',
                                                      mock_channel)
