...
class TestCalendar(RLEBAsyncTestCase):
    async def asyncSetUp(self):
        ...
        build = patch.object(rleb_calendar,
                                       "build",
    ...
    async def test_reddit_events(self):
        ...
        with patch.object(rleb_stdout, 'print_to_channel') as mocked_print_to_channel:
            ...
            mocked_print_to_channel.assert_awaited_once_with(mock_channel, expected_markup, title="reddit calendar for next 7 days")
    ...
    async def test_google_sheets_events(self):
        ...
        with patch.object(rleb_stdout, 'print_to_channel') as mocked_print_to_channel:
            ...
            mocked_print_to_channel.assert_awaited_once_with(mock_channel, expected_markup, title="sheets calendar for next 7 days")
